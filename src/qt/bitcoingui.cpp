...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Scash address"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Scash network", "", count));
}
...
#ifdef LINUX
        if (notificator) notificator->notify(Notificator::Information,
