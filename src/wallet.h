...
public:
    ...
    bool CreateTransaction(const std::vector<std::pair<CScript, int64> >& vecSend,
                           CWalletTx& wtxNew, CReserveKey& reservekey, int64& nFeeRet,
                           const CCoinControl *coinControl, std::string payName,
                           int messageBytes);
    bool CreateTransaction(CScript scriptPubKey, int64 nValue, CWalletTx& wtxNew, CReserveKey& reservekey,
                           int64& nFeeRet, const CCoinControl *coinControl, std::string payName, int messageBytes);
    ...
    std::string SendMoney(CScript scriptPubKey, int64 nValue, CWalletTx& wtxNew, bool fAskFee, int messageBytes);
    std::string SendMoneyToDestination(const CTxDestination &address, int64 nValue, CWalletTx& wtxNew, bool fAskFee, int messageBytes);
