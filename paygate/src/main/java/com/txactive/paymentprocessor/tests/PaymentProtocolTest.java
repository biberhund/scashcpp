 ...
 * Copyright 2018 SpeedCash developers
 *
...
package txactive.paymentprocessor.protocols.payments;

import txactive.paymentprocessor.core.Address;
import txactive.paymentprocessor.core.Coin;
import txactive.paymentprocessor.core.ECKey;
import txactive.paymentprocessor.core.LegacyAddress;
import txactive.paymentprocessor.core.NetworkParameters;
import txactive.paymentprocessor.core.Transaction;
import txactive.paymentprocessor.crypto.X509Utils;
import txactive.paymentprocessor.params.TestNet3Params;
import txactive.paymentprocessor.params.UnitTestParams;
import txactive.paymentprocessor.protocols.payments.PaymentProtocol.Output;
import txactive.paymentprocessor.protocols.payments.PaymentProtocol.PkiVerificationData;
import txactive.paymentprocessor.protocols.payments.PaymentProtocolException.PkiVerificationException;
import txactive.paymentprocessor.script.ScriptBuilder;
import txactive.paymentprocessor.testing.FakeTxBuilder;
import txactive.paymentprocessor.payments.Protos;
import txactive.paymentprocessor.payments.Protos.Payment;
import txactive.paymentprocessor.payments.Protos.PaymentACK;
import txactive.paymentprocessor.payments.Protos.PaymentRequest;
