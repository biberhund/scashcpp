...
package txactive.paymentprocessor.tools;

import txactive.paymentprocessor.crypto.*;
import txactive.paymentprocessor.MainNetParams;
import txactive.paymentprocessor.RegTestParams;
import txactive.paymentprocessor.TestNet3Params;
import txactive.paymentprocessor.payments.PaymentProtocol;
import txactive.paymentprocessor.payments.PaymentProtocolException;
import txactive.paymentprocessor.payments.PaymentSession;
import txactive.paymentprocessor.script.ScriptBuilder;
import txactive.paymentprocessor.script.ScriptException;
import txactive.paymentprocessor.script.ScriptPattern;
import txactive.paymentprocessor.store.*;
import txactive.paymentprocessor.uri.BitcoinURI;
import txactive.paymentprocessor.uri.BitcoinURIParseException;
import txactive.paymentprocessor.utils.BriefLogFormatter;
import txactive.paymentprocessor.wallet.DeterministicSeed;
import txactive.paymentprocessor.DeterministicUpgradeRequiredException;
import txactive.paymentprocessor.DeterministicUpgradeRequiresPassword;
...
import txactive.paymentprocessor.AbstractBlockChain;
import txactive.paymentprocessor.Address;
import txactive.paymentprocessor.AddressFormatException;
import txactive.paymentprocessor.Base58;
import txactive.paymentprocessor.Block;
import txactive.paymentprocessor.BlockChain;
import txactive.paymentprocessor.CheckpointManager;
import txactive.paymentprocessor.Coin;
import txactive.paymentprocessor.Context;
import txactive.paymentprocessor.DumpedPrivateKey;
import txactive.paymentprocessor.ECKey;
import txactive.paymentprocessor.FilteredBlock;
import txactive.paymentprocessor.FullPrunedBlockChain;
import txactive.paymentprocessor.InsufficientMoneyException;
import txactive.paymentprocessor.LegacyAddress;
import txactive.paymentprocessor.NetworkParameters;
import txactive.paymentprocessor.Peer;
import txactive.paymentprocessor.PeerAddress;
import txactive.paymentprocessor.PeerGroup;
import txactive.paymentprocessor.Sha256Hash;
import txactive.paymentprocessor.StoredBlock;
import txactive.paymentprocessor.Transaction;
import txactive.paymentprocessor.TransactionInput;
import txactive.paymentprocessor.TransactionOutput;
import txactive.paymentprocessor.Utils;
import txactive.paymentprocessor.VerificationException;
import txactive.paymentprocessor.listeners.BlocksDownloadedEventListener;
import txactive.paymentprocessor.listeners.DownloadProgressTracker;
import txactive.paymentprocessor.wallet.MarriedKeyChain;
import txactive.paymentprocessor.wallet.Protos;
import txactive.paymentprocessor.wallet.SendRequest;
import txactive.paymentprocessor.wallet.Wallet;
import txactive.paymentprocessor.wallet.WalletExtension;
import txactive.paymentprocessor.wallet.WalletProtobufSerializer;
import txactive.paymentprocessor.wallet.Wallet.BalanceType;
import txactive.paymentprocessor.wallet.listeners.WalletChangeEventListener;
import txactive.paymentprocessor.wallet.listeners.WalletCoinsReceivedEventListener;
import txactive.paymentprocessor.wallet.listeners.WalletCoinsSentEventListener;
import txactive.paymentprocessor.wallet.listeners.WalletReorganizeEventListener;
...
import static txactive.paymentprocessor.Coin.parseCoin;
...
public class WalletTool {
    ...
    private static txactive.paymentprocessor.protocols.payments.Protos.PaymentRequest paymentRequest;
    ...
    private static void sendPaymentRequest(String location, boolean verifyPki) {
        if (location.startsWith("http") || location.startsWith("scash")) {
            try {
            ...
            try {
                paymentRequest = txactive.paymentprocessor.protocols.payments.Protos.PaymentRequest.newBuilder().mergeFrom(stream).build();
            } catch(IOException e) {
