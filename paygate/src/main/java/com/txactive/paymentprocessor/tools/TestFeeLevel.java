...
import txactive.paymentprocessor.core.listeners.PeerConnectedEventListener;
import txactive.paymentprocessor.core.listeners.PeerDisconnectedEventListener;
import txactive.paymentprocessor.kits.WalletAppKit;
...
public class TestFeeLevel {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length == 0) {
            System.err.println("Specify the fee rate to test in SCS/kB as the first argument.");
            return;
        }
