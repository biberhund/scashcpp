...
import txactive.paymentprocessor.core.listeners.*;
import txactive.paymentprocessor.core.NetworkParameters;
import txactive.paymentprocessor.core.Peer;
import txactive.paymentprocessor.core.PeerGroup;
...
import txactive.paymentprocessor.wallet.DefaultRiskAnalysis;
import txactive.paymentprocessor.wallet.RiskAnalysis.Result;
...
public class WatchMempool {
    ...
    private static final long STATISTICS_FREQUENCY_MS = 1000;
